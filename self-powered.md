...
aggcalc.0.expr: [Home (kWh)] - [From Powerwall (kWh)] - [From Grid (kWh)]
aggcalc.1.name: Self Powered
aggcalc.1.expr: round(100 * ([From Solar (kWh)] + [From Powerwall (kWh)]) / [Home (kWh)], 0) + '%'
...
field.1: Home (kWh)
field.2: From Solar (kWh)
field.3: From Powerwall (kWh)
field.4: From Grid (kWh)
